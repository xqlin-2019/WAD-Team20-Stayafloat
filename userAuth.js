...
function process_login(){
    ...
    var url = `./userAuth.php?action=login&email=${email}&password=${password}`;
...
// User Registration
  function process_register(){
    ...
    var url = `./userAuth.php?action=register&email=${email}&password=${password}&sur_name=${sur_name}&given_name=${given_name}&faculty=${faculty}&preference=${preference}`;
  ...
  function check_exist(){
    ...
    var email = document.getElementById("email").value;
    var url = `./userAuth.php?action=exist&email=${email}`;
...
function check_exist(){
  ...
  function update_preference(){
    ...
    var url = `./userAuth.php?action=updatePreference&email=${email}&preference=${new_preference}`;
    request.open("GET", url, true); // synchronous
    request.send();
  }
  ...
  function update_password(){
    ...
    var url = `./userAuth.php?action=updatePassword&email=${email}&password=${new_password}`;
    request.open("GET", url, true); // synchronous
    request.send();
  }
